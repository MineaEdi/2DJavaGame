...
public class NPC_1 extends Entity
{
    ...
    public void getNPC1Image()
    {
        try
        {
            ...
            npc1_dead1 = ImageIO.read(getClass().getResourceAsStream("/npc1/NPC1_dying1.png"));
            npc1_dead2 = ImageIO.read(getClass().getResourceAsStream("/npc1/NPC1_dying2.png"));
            npc1_dead3 = ImageIO.read(getClass().getResourceAsStream("/npc1/NPC1_dying3.png"));
            npc1_dead4 = ImageIO.read(getClass().getResourceAsStream("/npc1/NPC1_dying4.png"));
            npc1_dead5 = ImageIO.read(getClass().getResourceAsStream("/npc1/NPC1_dying5.png"));
            npc1_dead6 = ImageIO.read(getClass().getResourceAsStream("/npc1/NPC1_dying6.png"));
